            ...
            <div class="card my-5 mx-auto shadow">
                ...
                <div class="card-body" style="overflow-x:scroll;">
                    <table class="table table-bordered table-striped">
                        ...
                        // nombre de ligne sur la table produit
                        ...
                        ?>
                            <tr>
                                    ...
                                    <td><?= $produit['prix'];?></td>
                                    <td>
                                        <img src="image/<?= $produit['image'];?>" alt="" class="objet-fit-over"
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="view.php?id=<?= $produit['id']?>" class="me-3"><i class="bi bi-eye-fill"></i></i></a>
                                            <a href="edit.php?id=<?= $produit['id']?>" class="me-2"><i class="bi bi-pencil-square"></i></a>
                                            <form action="code.php" method="post">
                                                <button type="submit" name="delete" class="border-0 bg-transparent 
                                                text-danger" value="<?= $produit['id']?>" onclick="return confirm('etes vous sur de supprimer <?= $produit['nom'];?> ?');"><i class="bi bi-trash3-fill"></i></button>
                                            </form>
                                        </div>
                                    </td>
                            </tr>
